...
<body>
  ...
  exportExcel(): void {
    this.api.exportInvoicesExcel().subscribe(blob => this.downloadFile(blob, 'Facturas.xlsx'));
  }

  exportPdf(): void {
    this.api.exportInvoicesPdf().subscribe(blob => this.downloadFile(blob, 'Facturas.pdf'));
  }
